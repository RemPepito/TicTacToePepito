...
public class TicTacToe implements ActionListener{
	...
	TicTacToe(){
		...
		textfield.setFont(new Font("3DUMB",Font.BOLD,75));
		...
		for(int i=0;i<9;i++) {
			...
			buttons[i].setFont(new Font("3DUMB",Font.BOLD,120));
			buttons[i].setFocusable(false);
			buttons[i].addActionListener(this);
		}

		resetButton.setBackground(Color.black);
		resetButton.setFont(new Font("3DUMB",Font.BOLD,60));
		...
		buttonPanel.add(resetButton,0,9);
		firstTurn();
	}
